...
import pandas as pd
import dash_auth #Importación librería dash_auth

#Crear objeto lista con cada usuario-contraseña en sublistas
LISTA_USUARIOS = [["Juan","007"],["Laura","200"]]

app = dash.Dash()
#Creación autenticación con método BasicAuth sobre nuestra app y usando la LISTA_USUARIOS
...
# CARGA DE DATOS
df_ventas = pd.read_excel(r'C:\Users\ivan_pinar\Dropbox\Creación de MOCs\MOC Dash Python\Datasets\PROYECTO FINAL\Ventas.xlsx',sheet_name="Detalle")
df_ventas_acum = pd.read_excel(r'C:\Users\ivan_pinar\Dropbox\Creación de MOCs\MOC Dash Python\Datasets\PROYECTO FINAL\Ventas.xlsx',sheet_name="Acumulado")
